...
public class TwoDimensionDemo1 {
    public static void main(String[] args) {
        ...
        System.out.println(arr3[0]);  // 表示获取二维数组中的第一个一维数组  [I@776ec8df

        // arr3[o]：二维数组中的第一个一维数组
        // arr3[θ][0]:获取第一个一维数组中0索引的元素
        // System.out.println(arr3[0][0]);     // 打印结果：1
        // System.out.println(arr3[1][4]);     // 打印结果：8
        // System.out.println(arr3[2][0]);     // 超出数组范围
